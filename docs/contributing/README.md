...
- Use the repo skill index when the work is clearly centered on `auth-surface-sync`, import workflow or import AI doc sync, ticket AI doc sync, release-cut cleanup, or other repeated multi-step contributor workflows.
