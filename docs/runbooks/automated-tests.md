...
Latest Productization Baseline frontend workspace result on 2026-05-07:
...
Then follow [deployment-runtime-smoke-test.md](deployment-runtime-smoke-test.md) for health, admin page load, login, context, Tickets, Feature Flags, Imports, Approvals, sign-out, and old-token `401` checks.
