...
- [ai-live-smoke-test.md](ai-live-smoke-test.md): local `.env`-driven provider live smoke path for the current public AI surface, starting with ticket summary and expanding to import AI error summary only after the first live pass succeeds
