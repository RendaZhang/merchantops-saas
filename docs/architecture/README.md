...
- [admin-console-architecture.md](admin-console-architecture.md): standalone Vite admin-console module, API client boundary, token storage boundary, and deferred auth lifecycle
