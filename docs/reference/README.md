...
- [authentication-and-rbac.md](authentication-and-rbac.md): login flow, JWT usage, context propagation, RBAC expectations, and the current AI summary and triage read permission boundary
...
- [ticket-workflow.md](ticket-workflow.md): current `/api/v1/tickets` workflow loop, workflow-log behavior, and the public AI summary and triage read slices
...
- [ai-integration.md](ai-integration.md): current AI workflow placement, permission boundaries, public AI summary and triage contracts, and audit/eval expectations
