...
- [ai-integration.md](ai-integration.md): current AI workflow placement, permission boundaries, tenant AI usage-summary plus public ticket/import AI contracts, and audit/eval expectations
