...
- [authentication-and-rbac.md](authentication-and-rbac.md): login flow, JWT usage, context propagation, RBAC expectations, the current AI interaction-history/summary/triage/reply-draft permission boundary, and action-aware approval visibility
