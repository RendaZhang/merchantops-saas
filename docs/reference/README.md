...
- [ai-integration.md](ai-integration.md): current AI workflow placement, permission boundaries, public AI interaction-history, summary, triage, and reply-draft contracts, and audit/eval expectations
