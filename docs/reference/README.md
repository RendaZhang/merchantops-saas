...
- [audit-approval.md](audit-approval.md): generic audit-event backbone status, minimal audit query API, the current `USER_STATUS_DISABLE` and `IMPORT_JOB_SELECTIVE_REPLAY` approval scope, and how AI interaction records stay separate
