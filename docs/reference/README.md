...
- [authentication-and-rbac.md](authentication-and-rbac.md): login flow, JWT usage, context propagation, RBAC expectations, and the current AI summary read permission boundary
...
- [ticket-workflow.md](ticket-workflow.md): current `/api/v1/tickets` workflow loop, workflow-log behavior, and the public AI summary read slice
...
- [ai-integration.md](ai-integration.md): current AI workflow placement, permission boundaries, public AI summary contract, and audit/eval expectations
