...
- [import-jobs.md](import-jobs.md): current `/api/v1/import-jobs` async contract, `USER_CSV` row-execution behavior, import AI error summary, and status/error model
