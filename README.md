...
- Tenant-scoped ticket workflow with list, detail, create, assignee change, status change, comment flow, queue filters, and a suggestion-only AI summary read path
...
- The current public AI surface is limited to one suggestion-only ticket summary endpoint; broader ticket AI flows and any AI write-back remain pending
