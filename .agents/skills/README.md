...
- [phase-status-sync/SKILL.md](phase-status-sync/SKILL.md): keep `project-status`, `roadmap`, `project-plan`, and `product-strategy` aligned without mixing their responsibilities.
