...
class TicketSummaryGoldenSampleTest {
    ...
    @Test
    void goldenSamplesShouldKeepStableSummaryFormatThroughSharedEvalRunner() throws Exception {
        AiWorkflowEvalInventoryEntry inventoryEntry = AiWorkflowEvalInventory.forWorkflow(AiGenerationWorkflow.TICKET_SUMMARY);
