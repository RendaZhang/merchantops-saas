...
class TicketTriageGoldenSampleTest {
    ...
    @Test
    void goldenSamplesShouldKeepStableTriageFormatThroughSharedEvalRunner() throws Exception {
        AiWorkflowEvalInventoryEntry inventoryEntry = AiWorkflowEvalInventory.forWorkflow(AiGenerationWorkflow.TICKET_TRIAGE);
