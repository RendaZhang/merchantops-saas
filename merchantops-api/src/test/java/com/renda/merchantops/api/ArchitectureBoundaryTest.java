...
class ArchitectureBoundaryTest {
    ...
    static final ArchRule activated_api_boundary_should_not_depend_on_infra =
            noClasses().that().haveFullyQualifiedName("com.renda.merchantops.api.auth.AuthService")
                    ...
                    .or().haveFullyQualifiedName("com.renda.merchantops.api.featureflag.FeatureFlagQueryService")
                    .or().haveFullyQualifiedName("com.renda.merchantops.api.featureflag.FeatureFlagCommandService")
                    ...
                    .or().haveFullyQualifiedName("com.renda.merchantops.api.importjob.ai.ImportJobAiMappingSuggestionService")
                    .or().haveFullyQualifiedName("com.renda.merchantops.api.importjob.ai.ImportJobAiFixRecommendationService")
