...
CREATE TABLE import_job_item_error (
    ...
    CONSTRAINT fk_import_job_item_error_job FOREIGN KEY (import_job_id) REFERENCES import_job(id)
);

CREATE INDEX idx_import_job_lookup ON import_job (tenant_id, id);
