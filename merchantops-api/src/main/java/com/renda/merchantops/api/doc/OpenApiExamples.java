...
public final class OpenApiExamples {
    ...
    public static final String RESP_USER_LIST = "{\"code\":\"SUCCESS\",\"message\":\"ok\",\"data\":[{\"id\":1,\"username\":\"admin\",\"displayName\":\"Demo Admin\",\"email\":\"admin@demo-shop.local\",\"status\":\"ACTIVE\"},{\"id\":2,\"username\":\"ops\",\"displayName\":\"Ops User\",\"email\":\"ops@demo-shop.local\",\"status\":\"ACTIVE\"},{\"id\":3,\"username\":\"viewer\",\"displayName\":\"Viewer User\",\"email\":\"viewer@demo-shop.local\",\"status\":\"ACTIVE\"}]}";
