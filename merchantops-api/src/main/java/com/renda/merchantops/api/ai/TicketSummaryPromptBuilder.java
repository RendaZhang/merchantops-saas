...
public class TicketSummaryPromptBuilder {
    ...
    public TicketSummaryPrompt build(String promptVersion, TicketDetailResponse ticket) {
        ...
        return new TicketSummaryPrompt(promptVersion, SYSTEM_PROMPT, userPrompt.toString());
    }
