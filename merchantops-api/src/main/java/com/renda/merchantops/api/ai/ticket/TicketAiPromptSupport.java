package com.renda.merchantops.api.ai.ticket;
...
public final class TicketAiPromptSupport {
    ...
    public static String buildUserPrompt(TicketPromptContext ticket) {
    ...
    private static void appendComments(StringBuilder userPrompt,
                                       List<TicketPromptContext.Comment> comments,
                                       boolean olderCommentsOmitted) {
        // Keep the most recent window readable while still signaling truncated history to the model.
        userPrompt.append('\n').append("Comments\n");
    ...
    private static void appendOperationLogs(StringBuilder userPrompt,
                                            List<TicketPromptContext.OperationLog> operationLogs,
