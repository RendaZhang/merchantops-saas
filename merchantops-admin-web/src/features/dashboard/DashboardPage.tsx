    ...
    <section>
      <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        ...
        <p className="max-w-xl text-sm text-neutral-600">
          Tickets now opens the first read-only workflow screen. Remaining
          pages stay behind later slices.
        </p>
      </div>

      <div className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        <article className="min-h-36 rounded-lg border border-emerald-200 bg-white p-5">
          ...
          <p className="mt-4 text-sm leading-6 text-neutral-600">
            Read-only queue for current-tenant tickets through the existing
            public ticket list API.
          </p>
        </article>
